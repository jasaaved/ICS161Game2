...
public class TransitionalObject : MonoBehaviour
{
    ...
    {
        if(transitions.Length > 0)
            if(transitions[0] != null && transitions[0].parent != null && !transitions[0].parent.Equals(this))//if the transitions parent isn't this object then this object has been copy pasted
            {
